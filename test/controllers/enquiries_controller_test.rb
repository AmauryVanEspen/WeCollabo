...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { email: @enquiry.email, enquiry_type: @enquiry.enquiry_type, messge: @enquiry.messge, name: @enquiry.name, phone: @enquiry.phone }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { email: @enquiry.email, enquiry_type: @enquiry.enquiry_type, messge: @enquiry.messge, name: @enquiry.name, phone: @enquiry.phone }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
